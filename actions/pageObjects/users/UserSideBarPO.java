...
public class UserSideBarPO extends BasePage {
    ...
    public UserAddressPO openAddressPage() {
        waitForElementClickable(driver, UserSideBarPageUI.ADDRESS_LINK, 15);
    ...
    public UserBackInStockSubscriptionsPO openBackInStockSubscriptionsPage() {
        waitForElementClickable(driver, UserSideBarPageUI.BACK_IN_STOCK_SUBSCRIPTIONS_LINK, 15);
    ...
    public UserChangePasswordPO openChangePasswordPage() {
        waitForElementClickable(driver, UserSideBarPageUI.CHANGE_PASSWORD_LINK, 15);
    ...
    public UserDownloadableProductsPO openDownloadableProductsPage() {
        waitForElementClickable(driver, UserSideBarPageUI.DOWNLOADABLE_PRODUCTS_LINK, 15);
    ...
    public UserMyProductReviewsPO openMyProductReviewsPage() {
        waitForElementClickable(driver, UserSideBarPageUI.MY_PRODUCT_REVIEWS_LINK, 15);
    ...
    public UserOrdersPO openOrdersPage() {
        waitForElementClickable(driver, UserSideBarPageUI.ORDERS_LINK, 15);
    ...
    public UserRewardPointsPO openRewardPointsPage() {
        waitForElementClickable(driver, UserSideBarPageUI.REWARD_POINTS_LINK, 15);
